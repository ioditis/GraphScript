...
namespace FitDex_svg_test
{
    ...
    public partial class FitDex : Matcher<char, string>
    {
        ...
        label0:
            ...
            _r1 = _MemoCall(_memo, "NL", _index, NL, null);
            ...
            {
                _memo.Results.Push(new _FitDex_Item(_start_i0, _index, _memo.InputEnumerable, _res0.Where(_NON_NULL), true));
            }
        ...
        public void NL(_FitDex_Memo _memo, int _index, _FitDex_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _FitDex_Item(_r2.StartIndex, _r2.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { Interpreter.LineNext(); return "OK"; }, _r2), true) );
            }
        ...
        label1: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _FitDex_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { string vName = string.Concat( v.Inputs );    // variable name
        ...
        label2: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _FitDex_Item(_r1.StartIndex, _r1.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { string cName = string.Concat( c.Inputs ); // class name
        ...
        label2:
            ...
            _r4 = _MemoCall(_memo, "Eq", _index, Eq, null);
        ...
        public void VariableValue(_FitDex_Memo _memo, int _index, _FitDex_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _FitDex_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return Elements.Graphics.GetVariable( string.Concat( v.Inputs ) ).value; }, _r0), true) );
            }
